...
| | When | Where |
| --- | --- | --- |
| Homework deadline reminders | `REMINDER_CRON` | In-process |
| Check-in reminders, a day before closing | `REMINDER_CRON` | In-process |
| Class reminders, two hours before | `REMINDER_CRON` | In-process |
